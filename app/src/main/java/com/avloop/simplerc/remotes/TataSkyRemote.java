        ...
        for ( int i = 0; i < Keys.MAX_KEYS; i++)
        {
            switch ( i ) {
                case Keys.POWER:
                    ...
                    break;
                case Keys.INFO:
                    keyCodes[i] = new int[]{36144, 96, 33, 16, 16, 16, 16, 16, 32, 16, 32, 32, 16, 16, 16, 16, 17, 16, 16, 16, 16, 16, 17, 15, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 32, 16, 16, 32, 16, 16, 32, 32, 32, 16, 16, 5051 };
                    break;
                case Keys.LIVETV:
                    keyCodes[i] = new int[]{36144, 96, 33, 16, 16, 16, 16, 16, 32, 16, 32, 32, 17, 16, 16, 16, 16, 16, 17, 16, 16, 16, 16, 16, 17, 16, 16, 16, 16, 16, 17, 16, 16, 16, 16, 32, 33, 16, 16, 16, 17, 15, 16, 16, 16, 16, 16, 16, 16, 16, 4515};
                    break;
                case Keys.UP:
                ...
                case Keys.GUIDE:
                    ...
                    break;
                case Keys.PLANNER:
                    keyCodes[i] = new int[]{36363, 96, 33, 16, 16, 16, 16, 16, 32, 16, 32, 32, 16, 16, 16, 16, 17, 15, 16, 16, 16, 16, 17, 15, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 17, 32, 16, 16, 17, 15, 32, 16, 4515};
                    break;
                case Keys.PAUSE:
                ...
                case Keys.FF:
                    ...
                    break;
                case Keys.REC:
                    keyCodes[i] = new int[]{36363, 96, 33, 16, 16, 16, 16, 16, 32, 16, 32, 32, 16, 16, 16, 16, 17, 16, 16, 16, 16, 16, 17, 15, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 32, 32, 16, 17, 16, 16, 16, 16, 16, 17, 16, 16, 16, 4515 };
                    break;
                case Keys.CHDOWN:

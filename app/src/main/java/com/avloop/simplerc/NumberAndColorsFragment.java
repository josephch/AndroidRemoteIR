 ...
 * along with SimpleRC.  If not, see <http://www.gnu.org/licenses/>.
 */
...
public class NumberAndColorsFragment extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.numberinput, container, false);
    }
